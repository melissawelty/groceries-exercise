...
with open(csv_filepath, "r") as csv_file: # "r" means "open the file for reading"
    ...
    for row in reader:
        ...
        # products.append(row) # gives us price values as string, and ID values as string
        row["price"] = float(row["price"]) #change price from string to float
        products.append(row)

# todo assemble a products variable by reading from csv file 
